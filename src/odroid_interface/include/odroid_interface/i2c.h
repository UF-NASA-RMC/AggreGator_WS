...
#include "shared_files/WriteI2CRegister.h"
#include "shared_files/ReadI2CRegister.h"

#define MAX_READ_BYTES 41
#define MAX_WRITE_BYTES 40
#define FILENAME "/dev/i2c-1"   //_______ I changed it from /dev/i2c-2 to /dev/i2c-1 _______//
...
class I2C {
	...
	//callbacks
	static bool ReadI2CCallback(shared_files::ReadI2C::Request&  request,
                     shared_files::ReadI2C::Response& reply);

	static bool ReadRegisterI2CCallback(shared_files::ReadI2CRegister::Request&  request,
                             shared_files::ReadI2CRegister::Response& reply);

	static void WriteI2CCallback(const shared_files::WriteI2C& msg);

	static void WriteRegisterI2C(const shared_files::WriteI2CRegister& msg);
};
