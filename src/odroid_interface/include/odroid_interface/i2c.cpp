 ...
 * Callbacks
 **************************/
bool I2C::ReadI2CCallback(shared_files::ReadI2C::Request&  request,
...
bool I2C::ReadRegisterI2CCallback(shared_files::ReadI2CRegister::Request&  request,
...
//Write to I2C
void I2C::WriteI2CCallback(const shared_files::WriteI2C& msg)
{
...
void I2C::WriteRegisterI2C(const shared_files::WriteI2CRegister& msg)
{
    ROS_INFO("swag");
    char* data = (char*) malloc(msg.data.size());
    for(int i = 0; i < msg.data.size(); ++i)
